...
LOGGER_ID = int(getenv("LOGGER_ID", "1002092669982"))

# Get this value from @FallenxBot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6740012753"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/varaprasad123/LB_Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/cricketlovermusic")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/cricketlovermusic")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/91de3bdc11090c12f8964.jpg"
)
PING_IMG_URL = getenv(
